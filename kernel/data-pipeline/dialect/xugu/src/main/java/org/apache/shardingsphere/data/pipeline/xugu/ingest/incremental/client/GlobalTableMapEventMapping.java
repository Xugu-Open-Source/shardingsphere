...
public final class GlobalTableMapEventMapping {
    ...
    private static final Map<String, Map<Long, XuguBinlogTableMapEventPacket>> TABLE_MAP_EVENT_MAPPING = new ConcurrentHashMap<>();
     ...
     */
    public static Map<Long, XuguBinlogTableMapEventPacket> getTableMapEventMap(final String databaseURL) {
