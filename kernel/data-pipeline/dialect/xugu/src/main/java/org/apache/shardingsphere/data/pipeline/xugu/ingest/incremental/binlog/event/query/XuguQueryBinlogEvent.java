...
package org.apache.shardingsphere.data.pipeline.xugu.ingest.incremental.binlog.event.query;
 ...
 */
@Getter
public final class XuguQueryBinlogEvent extends XuguBaseBinlogEvent {
    ...
    public XuguQueryBinlogEvent(final String fileName, final long position, final long timestamp,
