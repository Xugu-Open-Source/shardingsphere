 ...
 */
@Getter
public final class XuguUpdateRowsBinlogEvent extends XuguBaseRowsBinlogEvent {
    
    private final List<Serializable[]> beforeRows;
    
    private final List<Serializable[]> afterRows;
    
    public XuguUpdateRowsBinlogEvent(final String fileName, final long position, final long timestamp,
