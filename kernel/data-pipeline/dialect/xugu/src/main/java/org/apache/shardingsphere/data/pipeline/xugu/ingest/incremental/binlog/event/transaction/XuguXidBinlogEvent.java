...
package org.apache.shardingsphere.data.pipeline.xugu.ingest.incremental.binlog.event.transaction;
 ...
 */
@Getter
public final class XuguXidBinlogEvent extends XuguBaseBinlogEvent {
    
    private final long xid;
    
    public XuguXidBinlogEvent(final String fileName, final long position, final long timestamp, final long xid) {
