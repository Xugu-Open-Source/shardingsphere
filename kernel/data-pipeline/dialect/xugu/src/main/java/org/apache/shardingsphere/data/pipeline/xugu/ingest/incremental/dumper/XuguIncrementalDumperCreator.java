 ...
 */
public final class XuguIncrementalDumperCreator implements DialectIncrementalDumperCreator {
    
    @Override
    public IncrementalDumper create(final CreateIncrementalDumperParameter param) {
        return new XuguIncrementalDumper(param.getContext(), param.getPosition(), param.getChannel(), param.getMetaDataLoader());
    }
