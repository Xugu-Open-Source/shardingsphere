...
/**
 * Data source meta data for XuGu.
 */
@Getter
public final class XuGuDataSourceMetaData implements DataSourceMetaData {
    ...
    private final Pattern pattern = Pattern.compile("jdbc:(xugu)(:loadbalance|:replication)?:(\\w*:)?//([\\w\\-\\.]+):?([0-9]*),?.*?/([\\w\\-]+);?\\S*", Pattern.CASE_INSENSITIVE);

    public XuGuDataSourceMetaData(final String url, final String username) {
