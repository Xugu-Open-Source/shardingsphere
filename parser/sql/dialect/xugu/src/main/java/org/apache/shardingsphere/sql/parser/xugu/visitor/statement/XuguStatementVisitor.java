...
package org.apache.shardingsphere.sql.parser.xugu.visitor.statement;
...
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.AssignmentValuesContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.BitExprContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.BitValueLiteralsContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.BlobValueContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.BooleanLiteralsContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.BooleanPrimaryContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.CaseExpressionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.CaseWhenContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.CastFunctionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.CastTypeContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.CharFunctionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.CollateClauseContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ColumnNameContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ColumnNamesContext;
...
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.FromClauseContext;
...
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.JoinedTableContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.JsonFunctionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.JsonFunctionNameContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.JsonTableFunctionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LimitClauseContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LimitOffsetContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LimitRowCountContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LiteralsContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LockClauseContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LockClauseListContext;
...
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.OrderByClauseContext;
...
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ProjectionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ProjectionsContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.QualifiedShorthandContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.QueryExpressionBodyContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.QueryExpressionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.QueryExpressionParensContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.QueryPrimaryContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.QuerySpecificationContext;
...
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.SeparatorNameContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.SetAssignmentsClauseContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ShorthandRegularFunctionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.SimpleExprContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.SingleTableClauseContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.SpecialFunctionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.StringLiteralsContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.String_Context;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.SubqueryContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.SubstringFunctionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.SystemVariableContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableAliasRefListContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableFactorContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableIdentOptWildContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableListContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableNameContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableReferenceContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableReferencesContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableStatementContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TableValueConstructorContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TemporalLiteralsContext;
...
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ViewNameContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ViewNamesContext;
...
/**
 * Statement visitor for Xugu.
 */
@Getter(AccessLevel.PROTECTED)
public abstract class XuguStatementVisitor extends XuguStatementBaseVisitor<ASTNode> {
    ...
    private ASTNode createCompareSegment(final BooleanPrimaryContext ctx) {
        ...
        if (null != ctx.predicate()) {
            ...
            right = new SubqueryExpressionSegment(
                    new SubquerySegment(ctx.subquery().start.getStartIndex(), ctx.subquery().stop.getStopIndex(), (XuguSelectStatement) visit(ctx.subquery()), getOriginalText(ctx.subquery())));
        }
    ...
    public final ASTNode visitSimpleExpr(final SimpleExprContext ctx) {
        ...
        if (null != ctx.subquery()) {
            SubquerySegment subquerySegment = new SubquerySegment(
                    ctx.subquery().getStart().getStartIndex(), ctx.subquery().getStop().getStopIndex(), (XuguSelectStatement) visit(ctx.subquery()), getOriginalText(ctx.subquery()));
            if (null != ctx.EXISTS()) {
    ...
    public ASTNode visitQueryExpressionParens(final QueryExpressionParensContext ctx) {
        ...
        XuguSelectStatement result = (XuguSelectStatement) visit(ctx.queryExpression());
    ...
    public ASTNode visitQueryExpression(final QueryExpressionContext ctx) {
        XuguSelectStatement result;
        if (null != ctx.queryExpressionBody()) {
            result = (XuguSelectStatement) visit(ctx.queryExpressionBody());
        } else {
            result = (XuguSelectStatement) visit(ctx.queryExpressionParens());
        }
    ...
    public ASTNode visitCteClause(final CteClauseContext ctx) {
        CommonTableExpressionSegment result = new CommonTableExpressionSegment(ctx.getStart().getStartIndex(), ctx.getStop().getStopIndex(), (AliasSegment) visit(ctx.alias()),
                new SubquerySegment(ctx.getStart().getStartIndex(), ctx.getStop().getStopIndex(), (XuguSelectStatement) visit(ctx.subquery()), getOriginalText(ctx.subquery())));
    ...
    public ASTNode visitQueryExpressionBody(final QueryExpressionBodyContext ctx) {
        ...
        if (null != ctx.queryExpressionBody()) {
            XuguSelectStatement result = new XuguSelectStatement();
            SubquerySegment left = new SubquerySegment(ctx.queryExpressionBody().start.getStartIndex(), ctx.queryExpressionBody().stop.getStopIndex(),
                    (XuguSelectStatement) visit(ctx.queryExpressionBody()), getOriginalText(ctx.queryExpressionBody()));
            result.setProjections(left.getSelect().getProjections());
            left.getSelect().getFrom().ifPresent(result::setFrom);
            ((XuguSelectStatement) left.getSelect()).getTable().ifPresent(result::setTable);
        ...
        if (null != ctx.queryExpressionParens()) {
            ...
            SubquerySegment left = new SubquerySegment(ctx.queryExpressionParens().start.getStartIndex(), ctx.queryExpressionParens().stop.getStopIndex(),
                    (XuguSelectStatement) visit(ctx.queryExpressionParens()), getOriginalText(ctx.queryExpressionParens()));
            result.setProjections(left.getSelect().getProjections());
            left.getSelect().getFrom().ifPresent(result::setFrom);
            ((XuguSelectStatement) left.getSelect()).getTable().ifPresent(result::setTable);
            result.setCombine(createCombineSegment(ctx.combineClause(), left));
    ...
    private CombineSegment createCombineSegment(final CombineClauseContext ctx, final SubquerySegment left) {
        ...
        SubquerySegment right = new SubquerySegment(ruleContext.start.getStartIndex(), ruleContext.stop.getStopIndex(), (XuguSelectStatement) visit(ruleContext), getOriginalText(ruleContext));
    ...
    public ASTNode visitDelete(final DeleteContext ctx) {
        XuguDeleteStatement result = new XuguDeleteStatement();
    ...
    public ASTNode visitSelect(final SelectContext ctx) {
        ...
        if (null != ctx.queryExpression()) {
            result = (XuguSelectStatement) visit(ctx.queryExpression());
            if (null != ctx.lockClauseList()) {
                result.setLock((LockSegment) visit(ctx.lockClauseList()));
            }
        } else if (null != ctx.selectWithInto()) {
            result = (XuguSelectStatement) visit(ctx.selectWithInto());
        } else {
            result = (XuguSelectStatement) visit(ctx.getChild(0));
        }
        result.addParameterMarkerSegments(getParameterMarkerSegments());
        return result;
    }
    ...
    public ASTNode visitTableFactor(final TableFactorContext ctx) {
        if (null != ctx.subquery()) {
            XuguSelectStatement subquery = (XuguSelectStatement) visit(ctx.subquery());
