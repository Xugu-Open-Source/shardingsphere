...
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.CallContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.DoStatementContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.HandlerStatementContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ImportStatementContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.IndexHintContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LoadDataStatementContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LoadStatementContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.LoadXmlStatementContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ProjectionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.ReturningClauseContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.TargetListContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.WindowClauseContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.WindowFunctionContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.WindowItemContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.WindowSpecificationContext;
import org.apache.shardingsphere.sql.parser.autogen.XuguStatementParser.WindowingClauseContext;
...
import org.apache.shardingsphere.sql.parser.statement.xugu.dml.XuguCallStatement;
import org.apache.shardingsphere.sql.parser.statement.xugu.dml.XuguDoStatement;
import org.apache.shardingsphere.sql.parser.statement.xugu.dml.XuguHandlerStatement;
import org.apache.shardingsphere.sql.parser.statement.xugu.dml.XuguImportStatement;
import org.apache.shardingsphere.sql.parser.statement.xugu.dml.XuguLoadDataStatement;
import org.apache.shardingsphere.sql.parser.statement.xugu.dml.XuguLoadXMLStatement;
 ...
 */
public final class XuguDMLStatementVisitor extends XuguStatementVisitor implements DMLStatementVisitor {
    
    @Override
    public ASTNode visitCall(final CallContext ctx) {
        List<ExpressionSegment> params = getExpressions(ctx.exprs().expr());
        ...
        return new XuguCallStatement(procedureName, params);
    }
    ...
    public ASTNode visitLoadDataStatement(final LoadDataStatementContext ctx) {
        XuguLoadDataStatement result = new XuguLoadDataStatement();
    ...
    public ASTNode visitLoadXmlStatement(final LoadXmlStatementContext ctx) {
        XuguLoadXMLStatement result = new XuguLoadXMLStatement();
        result.setTableSegment((SimpleTableSegment) visit(ctx.tableName()));
        return result;
    }
