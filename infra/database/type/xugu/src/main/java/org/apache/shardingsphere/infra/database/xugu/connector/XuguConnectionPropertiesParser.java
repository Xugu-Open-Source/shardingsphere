...
package org.apache.shardingsphere.infra.database.xugu.connector;
...
/**
 * Connection properties parser of XuguDB.
 */
public final class XuguConnectionPropertiesParser implements ConnectionPropertiesParser {
    ...
    public ConnectionProperties parse(final String url, final String username, final String catalog) {
        ...
        String currentSchema = jdbcUrl.getQueryProperties().getProperty("current_schema");
    ...
    private Properties buildDefaultQueryProperties() {
        ...
        result.setProperty("sockeTimeOut", "3600");
        return result;
    }
