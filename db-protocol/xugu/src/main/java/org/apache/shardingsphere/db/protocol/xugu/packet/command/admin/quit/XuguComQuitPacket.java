...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.admin.quit;
 ...
 */
public final class XuguComQuitPacket extends XuguCommandPacket {
    
    public XuguComQuitPacket() {
        super(XuguCommandPacketType.COM_QUIT);
    }
}
