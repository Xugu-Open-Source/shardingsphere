...
package org.apache.shardingsphere.db.protocol.xugu.packet.binlog.row.column.value.integer;
 ...
 */
public final class XuguInt24BinlogProtocolValue implements XuguBinlogProtocolValue {
    
    @Override
    public Serializable read(final XuguBinlogColumnDef columnDef, final XuguPacketPayload payload) {
        return payload.getByteBuf().readMediumLE();
    }
}
