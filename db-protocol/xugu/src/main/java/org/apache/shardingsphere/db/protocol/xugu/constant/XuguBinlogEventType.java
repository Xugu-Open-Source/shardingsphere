...
@Getter
public enum XuguBinlogEventType {
    ...
    private static final Map<Integer, XuguBinlogEventType> VALUE_AND_EVENT_TYPE_MAP = new HashMap<>(values().length, 1F);
    
    private final int value;
    
    static {
        for (XuguBinlogEventType each : values()) {
     ...
     */
    public static Optional<XuguBinlogEventType> valueOf(final int value) {
