 ...
 */
public final class XuguFractionalSeconds {
    ...
    public XuguFractionalSeconds(final int columnMeta, final XuguPacketPayload payload) {
        fractionalSecondsPrecision = columnMeta;
        nanos = convertFractionalSecondsToNanos(payload);
    }
    
    private int convertFractionalSecondsToNanos(final XuguPacketPayload payload) {
