...
@Getter
public enum XuguAuthenticationPlugin {
    ...
    private static final Map<String, XuguAuthenticationPlugin> VALUE_AND_COLUMN_TYPE_MAP = new HashMap<>(values().length, 1F);
    
    static {
        for (XuguAuthenticationPlugin each : values()) {
     ...
     */
    public static XuguAuthenticationPlugin getPluginByName(final String pluginName) {
