...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.query.binary.reset;
 ...
 */
@Getter
public final class XuguComStmtResetPacket extends XuguCommandPacket {
    
    private final int statementId;
    
    public XuguComStmtResetPacket(final XuguPacketPayload payload) {
        super(XuguCommandPacketType.COM_STMT_RESET);
