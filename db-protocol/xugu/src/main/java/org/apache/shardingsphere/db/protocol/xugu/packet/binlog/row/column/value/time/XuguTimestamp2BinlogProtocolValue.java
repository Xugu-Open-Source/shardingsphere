 ...
 */
public final class XuguTimestamp2BinlogProtocolValue implements XuguBinlogProtocolValue {
    ...
    public Serializable read(final XuguBinlogColumnDef columnDef, final XuguPacketPayload payload) {
        ...
        int nanos = columnDef.getColumnMeta() > 0 ? new XuguFractionalSeconds(columnDef.getColumnMeta(), payload).getNanos() : 0;
