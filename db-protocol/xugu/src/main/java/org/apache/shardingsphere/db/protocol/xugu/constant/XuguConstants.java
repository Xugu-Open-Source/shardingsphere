...
public final class XuguConstants {
    
    public static final AttributeKey<AtomicInteger> SEQUENCE_ID_ATTRIBUTE_KEY = AttributeKey.valueOf("MYSQL_SEQUENCE_ID");
    
    public static final AttributeKey<XuguCharacterSet> CHARACTER_SET_ATTRIBUTE_KEY = AttributeKey.valueOf(XuguCharacterSet.class.getName());
    ...
    public static final XuguCharacterSet DEFAULT_CHARSET = XuguCharacterSet.UTF8MB4_GENERAL_CI;
}
