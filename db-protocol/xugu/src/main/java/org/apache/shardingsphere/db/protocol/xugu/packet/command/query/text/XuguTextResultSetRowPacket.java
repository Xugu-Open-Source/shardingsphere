...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.query.text;
...
@Getter
public final class XuguTextResultSetRowPacket extends XuguPacket {
    
    private static final int NULL = 0xfb;
    
    private final Collection<Object> data;
    
    public XuguTextResultSetRowPacket(final XuguPacketPayload payload, final int columnCount) {
    ...
    private void writeDataIntoPayload(final XuguPacketPayload payload, final Object data) {
