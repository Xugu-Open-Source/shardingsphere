 ...
 */
public final class XuguDatetimeBinlogProtocolValue implements XuguBinlogProtocolValue {
    ...
    public Serializable read(final XuguBinlogColumnDef columnDef, final XuguPacketPayload payload) {
        ...
        return 0L == datetime ? XuguTimeValueUtils.DATETIME_OF_ZERO : readDateTime(datetime);
    }
