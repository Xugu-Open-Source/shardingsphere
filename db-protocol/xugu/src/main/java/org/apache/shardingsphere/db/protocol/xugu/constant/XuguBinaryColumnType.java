...
@Getter
public enum XuguBinaryColumnType implements BinaryColumnType {
    ...
    private static final Map<Integer, XuguBinaryColumnType> JDBC_TYPE_AND_COLUMN_TYPE_MAP = new HashMap<>(values().length, 1F);
    
    private static final Map<Integer, XuguBinaryColumnType> VALUE_AND_COLUMN_TYPE_MAP = new HashMap<>(values().length, 1F);
    ...
    static {
        ...
        JDBC_TYPE_AND_COLUMN_TYPE_MAP.put(Types.ROWID, VAR_STRING);
        ...
        JDBC_TYPE_AND_COLUMN_TYPE_MAP.put(3004, LONG);
        JDBC_TYPE_AND_COLUMN_TYPE_MAP.put(3005, LONG);
        JDBC_TYPE_AND_COLUMN_TYPE_MAP.put(3006, DOUBLE);
        JDBC_TYPE_AND_COLUMN_TYPE_MAP.put(3007, VAR_STRING);
        JDBC_TYPE_AND_COLUMN_TYPE_MAP.put(3008, VAR_STRING);
        JDBC_TYPE_AND_COLUMN_TYPE_MAP.put(3009, VAR_STRING);
        JDBC_TYPE_AND_COLUMN_TYPE_MAP.put(3010, VAR_STRING);
     ...
     */
    public static XuguBinaryColumnType valueOfJDBCType(final int jdbcType) {
     ...
     * @return column type
     */
    public static XuguBinaryColumnType valueOf(final int value) {
