...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.admin;
 ...
 */
@Getter
public final class XuguComSetOptionPacket extends XuguCommandPacket {
    ...
    public XuguComSetOptionPacket(final XuguPacketPayload payload) {
        super(XuguCommandPacketType.COM_SET_OPTION);
