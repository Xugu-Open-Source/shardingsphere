...
package org.apache.shardingsphere.db.protocol.xugu.packet.generic;
 ...
 */
@Getter
public final class XuguErrPacket extends XuguPacket {
    ...
    public XuguErrPacket(final SQLException exception) {
        errorCode = exception.getErrorCode();
        sqlState = exception.getSQLState();
        errorMessage = exception.getMessage();
    }
    
    public XuguErrPacket(final VendorError vendorError, final Object... errorMessageArgs) {
    ...
    public XuguErrPacket(final XuguPacketPayload payload) {
