 ...
 */
public final class XuguNullBitmap {
    ...
    public XuguNullBitmap(final int columnsNumbers, final int offset) {
        this.offset = offset;
        nullBitmap = new int[calculateLength(columnsNumbers, offset)];
    }
    
    public XuguNullBitmap(final int columnNumbers, final XuguPacketPayload payload) {
        offset = 0;
        nullBitmap = new int[calculateLength(columnNumbers, 0)];
        fillBitmap(payload);
    }
    
    private void fillBitmap(final XuguPacketPayload payload) {
