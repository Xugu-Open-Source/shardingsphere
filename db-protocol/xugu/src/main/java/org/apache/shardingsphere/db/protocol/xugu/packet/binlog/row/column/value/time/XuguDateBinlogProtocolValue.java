 ...
 */
public final class XuguDateBinlogProtocolValue implements XuguBinlogProtocolValue {
    ...
    public Serializable read(final XuguBinlogColumnDef columnDef, final XuguPacketPayload payload) {
        ...
        int day = date % 32;
        return 0 == date ? XuguTimeValueUtils.ZERO_OF_DATE : Date.valueOf(LocalDate.of(year, month, day));
    }
}
