...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.query.text.fieldlist;
 ...
 */
@Getter
public final class XuguComFieldListPacket extends XuguCommandPacket {
    
    private final String table;
    
    private final String fieldWildcard;
    
    public XuguComFieldListPacket(final XuguPacketPayload payload) {
        super(XuguCommandPacketType.COM_FIELD_LIST);
