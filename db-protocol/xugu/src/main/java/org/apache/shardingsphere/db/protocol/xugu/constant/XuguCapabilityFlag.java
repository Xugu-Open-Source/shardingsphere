...
@Getter
public enum XuguCapabilityFlag {
     ...
     */
    public static int calculateCapabilityFlags(final XuguCapabilityFlag... capabilities) {
        int result = 0;
        for (XuguCapabilityFlag each : capabilities) {
            result |= each.value;
        }
        return result;
    }
