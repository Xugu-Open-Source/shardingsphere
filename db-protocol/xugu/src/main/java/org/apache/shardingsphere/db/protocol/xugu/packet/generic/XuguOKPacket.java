...
@Getter
public final class XuguOKPacket extends XuguPacket {
    ...
    public XuguOKPacket(final int statusFlag) {
        this(0L, 0L, statusFlag, 0, "");
    }
    
    public XuguOKPacket(final long affectedRows, final long lastInsertId, final int statusFlag) {
        this(affectedRows, lastInsertId, statusFlag, 0, "");
    }
    
    public XuguOKPacket(final XuguPacketPayload payload) {
