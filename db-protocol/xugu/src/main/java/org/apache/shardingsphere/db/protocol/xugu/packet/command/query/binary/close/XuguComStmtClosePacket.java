...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.query.binary.close;
 ...
 */
@Getter
public final class XuguComStmtClosePacket extends XuguCommandPacket {
    
    private final int statementId;
    
    public XuguComStmtClosePacket(final XuguPacketPayload payload) {
        super(XuguCommandPacketType.COM_STMT_CLOSE);
