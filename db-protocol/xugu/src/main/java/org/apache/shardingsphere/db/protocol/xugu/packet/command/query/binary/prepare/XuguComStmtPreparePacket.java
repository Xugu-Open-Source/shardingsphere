...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.query.binary.prepare;
 ...
 */
public final class XuguComStmtPreparePacket extends XuguCommandPacket implements SQLReceivedPacket {
    ...
    public XuguComStmtPreparePacket(final XuguPacketPayload payload) {
        super(XuguCommandPacketType.COM_STMT_PREPARE);
