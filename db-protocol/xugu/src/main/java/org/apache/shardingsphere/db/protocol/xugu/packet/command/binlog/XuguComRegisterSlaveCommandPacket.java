...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.binlog;
 ...
 */
@Getter
public final class XuguComRegisterSlaveCommandPacket extends XuguCommandPacket {
    ...
    public XuguComRegisterSlaveCommandPacket(final int serverId, final String slaveHostname, final String slaveUser, final String slavePassword, final int slavePort) {
        super(XuguCommandPacketType.COM_REGISTER_SLAVE);
    ...
    public XuguComRegisterSlaveCommandPacket(final XuguPacketPayload payload) {
        super(XuguCommandPacketType.COM_REGISTER_SLAVE);
    ...
    @Override
    protected void doWrite(final XuguPacketPayload payload) {
