...
@Getter
public final class XuguAuthenticationPluginData {
    
    private final byte[] authenticationPluginDataPart1;
    
    private final byte[] authenticationPluginDataPart2;
    
    public XuguAuthenticationPluginData() {
        this(XuguRandomGenerator.getINSTANCE().generateRandomBytes(8), XuguRandomGenerator.getINSTANCE().generateRandomBytes(12));
    }
