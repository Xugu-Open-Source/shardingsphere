...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.query;
...
public final class XuguColumnDefinition41Packet extends XuguPacket {
    ...
    private final XuguBinaryColumnType columnType;
     ...
     */
    public XuguColumnDefinition41Packet(final int characterSet, final String schema, final String table, final String orgTable,
                                        final String name, final String orgName, final int columnLength, final XuguBinaryColumnType columnType,
    ...
    public XuguColumnDefinition41Packet(final XuguPacketPayload payload) {
        ...
        columnType = XuguBinaryColumnType.valueOf(payload.readInt1());
