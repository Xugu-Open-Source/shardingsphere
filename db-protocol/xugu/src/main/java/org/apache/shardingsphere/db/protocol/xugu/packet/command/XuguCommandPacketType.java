...
package org.apache.shardingsphere.db.protocol.xugu.packet.command;
...
@Getter
public enum XuguCommandPacketType implements CommandPacketType {
    ...
    private static final Map<Integer, XuguCommandPacketType> MYSQL_COMMAND_PACKET_TYPE_CACHE = new HashMap<>();
    
    private final int value;
    
    static {
        for (XuguCommandPacketType each : values()) {
     ...
     */
    public static XuguCommandPacketType valueOf(final int value) {
        XuguCommandPacketType result = MYSQL_COMMAND_PACKET_TYPE_CACHE.get(value);
