 ...
 */
public final class XuguYearBinlogProtocolValue implements XuguBinlogProtocolValue {
    
    @Override
    public Serializable read(final XuguBinlogColumnDef columnDef, final XuguPacketPayload payload) {
        int result = payload.readInt1();
        return 0 == result ? XuguTimeValueUtils.YEAR_OF_ZERO : Integer.toString(result + 1900);
    }
}
