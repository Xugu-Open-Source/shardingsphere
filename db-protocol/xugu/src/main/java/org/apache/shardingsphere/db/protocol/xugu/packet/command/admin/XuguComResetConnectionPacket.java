 ...
 */
public final class XuguComResetConnectionPacket extends XuguCommandPacket {
    
    public XuguComResetConnectionPacket() {
        super(XuguCommandPacketType.COM_RESET_CONNECTION);
    }
}
