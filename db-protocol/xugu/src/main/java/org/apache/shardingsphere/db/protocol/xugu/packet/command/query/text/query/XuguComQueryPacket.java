...
package org.apache.shardingsphere.db.protocol.xugu.packet.command.query.text.query;
 ...
 */
public final class XuguComQueryPacket extends XuguCommandPacket implements SQLReceivedPacket {
    ...
    public XuguComQueryPacket(final String sql) {
        super(XuguCommandPacketType.COM_QUERY);
        hintValueContext = SQLHintUtils.extractHint(sql);
        this.sql = SQLHintUtils.removeHint(sql);
    }
    
    public XuguComQueryPacket(final XuguPacketPayload payload) {
        super(XuguCommandPacketType.COM_QUERY);
