...
@Getter
public final class XuguAuthSwitchRequestPacket extends XuguPacket {
    ...
    public XuguAuthSwitchRequestPacket(final XuguPacketPayload payload) {
        ...
        authPluginData = new XuguAuthenticationPluginData(Arrays.copyOfRange(strAuthPluginData.getBytes(), 0, 8), Arrays.copyOfRange(strAuthPluginData.getBytes(), 8, 20));
    }
