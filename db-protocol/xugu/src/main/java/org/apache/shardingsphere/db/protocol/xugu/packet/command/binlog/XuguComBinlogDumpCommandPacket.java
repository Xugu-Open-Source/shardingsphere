 ...
 */
@Getter
public final class XuguComBinlogDumpCommandPacket extends XuguCommandPacket {
    ...
    public XuguComBinlogDumpCommandPacket(final int binlogPos, final int serverId, final String binlogFilename) {
        super(XuguCommandPacketType.COM_BINLOG_DUMP);
    ...
    public XuguComBinlogDumpCommandPacket(final XuguPacketPayload payload) {
        super(XuguCommandPacketType.COM_BINLOG_DUMP);
