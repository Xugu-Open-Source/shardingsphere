 ...
 */
@Getter
public final class XuguBinlogRotateEventPacket extends AbstractXuguBinlogEventPacket {
    
    private final long position;
    
    private final String nextBinlogName;
    
    public XuguBinlogRotateEventPacket(final XuguBinlogEventHeader binlogEventHeader, final long position, final String nextBinlogName) {
        super(binlogEventHeader);
        this.position = position;
        this.nextBinlogName = nextBinlogName;
    }
    
    public XuguBinlogRotateEventPacket(final XuguBinlogEventHeader binlogEventHeader, final XuguPacketPayload payload) {
        super(binlogEventHeader);
