 ...
 */
public final class XuguDoubleBinaryProtocolValue implements XuguBinaryProtocolValue {
    
    @Override
    public Object read(final XuguPacketPayload payload, final boolean unsigned) {
        return payload.getByteBuf().readDoubleLE();
    }
    
    @Override
    public void write(final XuguPacketPayload payload, final Object value) {
        payload.getByteBuf().writeDoubleLE(Double.parseDouble(value.toString()));
    }
}
