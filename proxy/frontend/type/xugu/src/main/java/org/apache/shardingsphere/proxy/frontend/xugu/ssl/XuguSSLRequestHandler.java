...
package org.apache.shardingsphere.proxy.frontend.xugu.ssl;
 ...
 */
public final class XuguSSLRequestHandler extends ByteToMessageDecoder {
    
    private static final int HEADER_LENGTH = 4;
    
    private static final int SSL_REQUEST_LENGTH = 32;
    
    public XuguSSLRequestHandler() {
    ...
    protected void decode(final ChannelHandlerContext context, final ByteBuf in, final List<Object> out) {
        ...
        if (isSSLRequest(in)) {
            ...
            context.pipeline().addAfter(XuguSSLRequestHandler.class.getSimpleName(), SslHandler.class.getSimpleName(), sslHandler);
    ...
    private boolean isSSLRequest(final ByteBuf in) {
        ...
        return SSL_REQUEST_LENGTH == in.getUnsignedMediumLE(in.readerIndex())
                && XuguCapabilityFlag.CLIENT_SSL.getValue() == (XuguCapabilityFlag.CLIENT_SSL.getValue() & in.getUnsignedShortLE(clientCapabilitiesFlagOffset));
    }
}
