...
package org.apache.shardingsphere.proxy.frontend.xugu.command.admin;
...
public final class XuguComSetOptionExecutor implements CommandExecutor {
    
    private final XuguComSetOptionPacket packet;
    
    private final ConnectionSession connectionSession;
    
    @Override
    public Collection<DatabasePacket> execute() {
        connectionSession.getAttributeMap().attr(XuguConstants.OPTION_MULTI_STATEMENTS_ATTRIBUTE_KEY).set(packet.getValue());
