 ...
 */
public final class XuguMultiStatementsHandler implements ProxyBackendHandler {
    ...
    public XuguMultiStatementsHandler(final ConnectionSession connectionSession, final SQLStatement sqlStatementSample, final String sql) {
    ...
    private SQLParserEngine getSQLParserEngine() {
        ...
        return sqlParserRule.getSQLParserEngine(TypedSPILoader.getService(DatabaseType.class, "XuGu"));
    }
