...
package org.apache.shardingsphere.proxy.frontend.xugu.authentication.authenticator.impl;
...
import org.apache.shardingsphere.proxy.frontend.xugu.authentication.authenticator.XuguAuthenticator;
 ...
 */
public final class XuguCachingSha2PasswordAuthenticator implements XuguAuthenticator {
    
    @Override
    public boolean authenticate(final ShardingSphereUser user, final Object[] authInfo) {
        byte[] authResponse = (byte[]) authInfo[0];
        XuguAuthenticationPluginData authPluginData = (XuguAuthenticationPluginData) authInfo[1];
    ...
    public String getAuthenticationMethodName() {
        return XuguAuthenticationMethod.CACHING_SHA2_PASSWORD.getMethodName();
    }
}
