...
package org.apache.shardingsphere.proxy.backend.xugu.handler.admin.executor.sysvar;
...
public enum XuguSystemVariable {
    ...
    VERSION(Flag.GLOBAL | Flag.READONLY, DatabaseProtocolServerInfo.getDefaultProtocolVersion(TypedSPILoader.getService(DatabaseType.class, "XuGu")), new VersionValueProvider()),
    ...
    private final XuguSystemVariableValueProvider variableValueProvider;
    
    XuguSystemVariable(final int flag, final String defaultValue) {
        this(flag, defaultValue, XuguSystemVariableValueProvider.DEFAULT_PROVIDER);
    }
